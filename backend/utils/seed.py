...
PRODUCTOS = [
    # Materia prima
    {
        ...
        "precio": 18500, "unidad": "m²", "categoria": "materia-prima",
        "imagen_url": "../src/img/materia-prima.png", "etiqueta": "Nuevo", "destacado": True,
    },
    {
        "nombre": "Cuero Crudo Natural",
        "descripcion": "Cuero sin curtir en su estado natural. Disponible en distintos tamaños y grosores.",
        "precio": 12000, "unidad": "m²", "categoria": "materia-prima",
        "imagen_url": "../src/img/cuero-crudo.png", "etiqueta": None, "destacado": False,
    },
    {
        ...
        "precio": 22000, "unidad": "m²", "categoria": "materia-prima",
        "imagen_url": "../src/img/materia-prima.png", "etiqueta": "Popular", "destacado": False,
    },
    {
        "nombre": "Cuero Repujado",
        "descripcion": "Cuero tratado especialmente para técnicas de repujado. Textura firme y uniforme.",
        "precio": 20000, "unidad": "m²", "categoria": "materia-prima",
        "imagen_url": "../src/img/materia-prima.png", "etiqueta": None, "destacado": False,
    },
    # Elaborados
    {
        "nombre": "Cartera Artesanal Premium",
        "descripcion": "Cartera de cuero genuino hecha a mano. Diseño clásico con terminación premium.",
        "precio": 45000, "unidad": None, "categoria": "elaborados",
        "imagen_url": "../src/img/productos-elaborados.png", "etiqueta": "Nuevo", "destacado": True,
    },
    {
        "nombre": "Cinturón Artesanal",
        "descripcion": "Cinturón de cuero con hebilla de bronce. Disponible en varios talles y colores.",
        "precio": 15000, "unidad": None, "categoria": "elaborados",
        "imagen_url": "../src/img/cinturon-cuero.png", "etiqueta": "Popular", "destacado": True,
    },
    {
        "nombre": "Billetera Clásica",
        "descripcion": "Billetera de cuero genuino con múltiples compartimentos. Costura a mano.",
        "precio": 12500, "unidad": None, "categoria": "elaborados",
        "imagen_url": "../src/img/billetera-cuero.png", "etiqueta": None, "destacado": False,
    },
    {
        "nombre": "Mochila Artesanal",
        "descripcion": "Mochila de cuero genuino con correas reforzadas. Diseño moderno y funcional.",
        "precio": 68000, "unidad": None, "categoria": "elaborados",
        "imagen_url": "../src/img/productos-elaborados.png", "etiqueta": "Popular", "destacado": False,
    },
    # Herramientas
    {
        ...
        "precio": 32000, "unidad": None, "categoria": "herramientas",
        "imagen_url": "../src/img/accesorios-cuero.png", "etiqueta": None, "destacado": False,
    },
    {
        ...
        "precio": 4500, "unidad": None, "categoria": "herramientas",
        "imagen_url": "../src/img/accesorios-cuero.png", "etiqueta": None, "destacado": False,
    },
    {
        ...
        "precio": 6800, "unidad": None, "categoria": "herramientas",
        "imagen_url": "../src/img/accesorios-cuero.png", "etiqueta": None, "destacado": False,
    },
    {
        ...
        "precio": 3200, "unidad": None, "categoria": "herramientas",
        "imagen_url": "../src/img/accesorios-cuero.png", "etiqueta": "Nuevo", "destacado": False,
    },
]
